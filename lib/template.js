...
module.exports={
    HTML:function(title, body, control) {
        ...
        <head>
          <meta charset="UTF-8" />
          <title>COVID-19 Co-morbidities - ${title}</title>
        ...
        <body>
          <div id="wrap">
              ...
              <div class="container">
                <div class="header">
                  <div class="header-menu" style="text-align: right">
                    <a href="/">COVID-19 Co-morbidities</a>
                  ...
                  <div class="header-tit">
                    <h2>Covid-19 Co-morbidities Guide</h2>
                  </div>
                </div>
              </div>
            </div><!--header-->
            ...
            <!-- <div id="nav">nav</div>
            <div id="side">side
              <form method="post" action="/topic/prepare">
                    ...
                    <div class="col-6 col-sm-4">
                      ...
                      <h3>Your Own Co-morbidities</h3>
                        ...
                        <button type="submit" class="btn btn-primary">Discover</button> -->
                          ...
                          <input type="text" name="RiskFactor" class="form-control" placeholder="Enter Query or Co-morbidities">
