              ...
              <ul>
                <form method="post" action="/topic/submit">
                  ...
                  <input
                    type="checkbox"
                    name="RiskFactor"
                    value="Severe Obesity (BMI ≥ 40 kg/m2)"
                  />
              ...
              <ul>
                <form method="post" action="/topic/submit">
                  <input
                    type="checkbox"
                    name="RiskFactor"
                    value="Asthma (moderate-to-severe)"
                  />
                  ...
                  <input
                    type="checkbox"
                    name="RiskFactor"
                    value="Hypertension or high blood pressure"
                  />
                  ...
                  <input
                    type="checkbox"
                    name="RiskFactor"
                    value="Overweight (BMI > 25 kg/m2, but < 30 kg/m2)"
                  />
                  Overweight (BMI > 25 kg/m2, but < 30 kg/m2)<br />
                  <input
                    type="checkbox"
                    name="RiskFactor"
                  ...
                  <input
                    type="checkbox"
                    name="RiskFactor"
                    value="Thalassemia (a type of blood disorder)"
                  />
